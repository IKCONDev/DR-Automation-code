Feature: Registrant-Enter-Contact-Details-and-logout-then-Registrar-Delete-Registrant-Uncomplete-onboarding-Account-then-Re-check-and-Re-Registration-SameAccount.
