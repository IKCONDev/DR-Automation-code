Feature: Registrant Onboarding
  ...
  Scenario Outline: Registrant Registration and login
    ...
    Examples: 
      ...
      | pracash.o@ikcon.com | Test@129 | Valid |
  ...
  Scenario Outline: Onboarding Page
    ...
    Examples: 
      ...
      | mtpr   | 500090 | CYBERTOWERS,Madhapur,HEDERABAD,Telangana | 9685578941 | 868557894 | ikcon@ | 22ABCDE0000A1J5 | ASDEE4455Q | L12345MH2023PLC000001 |
  ...
  Scenario Outline: Registrant Domain Page
    ...
    Examples: 
      | NS1     | NS2     | IP1        | IP2         |
      | Office1 | office2 | 1.10.53.30 | 1.101.54.15 |
