...
#
    #Examples: 
      #| username             | password | Case  |
      #| akashaya.g@ikcon.com | Test@129 | Valid |
#
...
#
    #Examples: 
      #| username            | password | Case  |
      #| anudeep.c@ikcon.com | Test@129 | Valid |
#
  #Scenario Outline: DSC Verify
    #And User enters the dsc details
#
...
#
    #Examples: 
      #| username          | password    | Case  | useremail           |
      #| pavan.m@gmail.com | Welcome@123 | Valid | anudeep.c@ikcon.com |
#
  #Scenario Outline: DSC Verify
    #And User enters the dsc details
#
  #Scenario Outline: Registrar Reports  Page
    #Then Registrar Delete Registrant Domain Application Oraphandata "<useremail>"
    #Then Registrar Can Check  logout funcionality
    #Examples: 
          #| useremail           |
          #| anudeep.c@ikcon.com |
...
#
    #Examples: 
      #| username            | password | Case  |
      #| archana.f@ikcon.com | Test@129 | Valid |
#
  #Scenario Outline: DSC Verify
    #And User enters the dsc details
#
...
#
    #Examples: 
      ...
      #| arachancdr | 500090 | CYBERTOWERS,Madhapur,HEDERABAD,Telangana | 968557 | 868557894 | ikcon@ | 22ABCDE0000A1J5 | ASDEE4455Q | L12345MH2023PLC000001 |
#
...
#
    #Examples: 
      #| username            | password | Case  |
      #| bishman.w@ikcon.com | Test@129 | Valid |
#
  #Scenario Outline: DSC Verify
    #And User enters the dsc details
#
...
#
    #Examples: 
      #| domain     | PIN    | Address                                  | Tel    | Mob       | Email  | GST             | PAN        | License               |
      #| bishmanwdr | 500090 | CYBERTOWERS,Madhapur,HEDERABAD,Telangana | 968557 | 868557894 | ikcon@ | 22ABCDE0000A1J5 | ASDEE4455Q | L12345MH2023PLC000001 |
#
  #Scenario Outline: Registrant Officer Details Management
    #Then User logout the application
#
...
#
    #Examples: 
      #| domain        | PIN    | Address                                  | Tel    | Mob       | Email  | GST             | PAN        | License               |
      #| chandirikavdr | 500090 | CYBERTOWERS,Madhapur,HEDERABAD,Telangana | 968557 | 868557894 | ikcon@ | 22ABCDE0000A1J5 | ASDEE4455Q | L12345MH2023PLC000001 |
#
...
#
    #Examples: 
      #| domain   | PIN    | Address                                  | Tel    | Mob       | Email  | GST             | PAN        | License               |
      #| draavidr | 500090 | CYBERTOWERS,Madhapur,HEDERABAD,Telangana | 968557 | 868557894 | ikcon@ | 22ABCDE0000A1J5 | ASDEE4455Q | L12345MH2023PLC000001 |
#
  #Scenario Outline: Admin Contact details
    #Then User enters admin contact details "<Name>" "<Tel>" "<Mob>" "<Email>" "<Aadhar>" "<PAN>" "<Desig>"
#
