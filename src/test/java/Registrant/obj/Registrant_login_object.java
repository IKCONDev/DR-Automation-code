...
public class Registrant_login_object extends Baseclass {
	...
	public void User_Register_An_Account(String username,String Password) throws Exception {
...
public void user_enters(String UN, String Password) throws InterruptedException {
	...
	public void Refresh_loginpage(WebDriver driver) {
		driver.navigate().refresh();
	}
	...
	@FindBy(xpath = "//button[@class='btn btn-primary ml-3 ng-star-inserted']")
	public WebElement adddomainclick;
	...
	public void user_should_get_logged_in_addDomain(String domain) throws InterruptedException, AWTException{
	
		//Thread.sleep(3000);
		Clickelement(DomainSearch);
		Thread.sleep(3000);
		Clickelement(adddomainclick);
...
//		}
		Thread.sleep(3000);
		validatetext(NS_Page_head, "Name Server Details");
		String Table_cold1="Server,Host Name,DNS Service Provider,IPV4 Address,IPV6 Address,IP Service Provider,Actions";
	...
	public void User_enter_name_server_details_Not_Enter_DNSSEC_details(String NSR,String IP1,String IPV6) throws AWTException, InterruptedException {
		configWriter.setProperty("NS1", NSR);
...
//		Clickelement(Delete.get(1));
	...
	@FindBy(xpath = "//input[@id='toggleModalCheckbox']")
	...
	@FindBy(xpath = "//div[normalize-space()='Delete Account']")
...
public void User_logout_the_application1 () throws Exception {
	    Thread.sleep(1000);
	    Clickelement(clickgotit);
	    Thread.sleep(1000);
		Clickelement(Profile_icon);
		Thread.sleep(1000);
