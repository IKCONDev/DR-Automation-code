...
public class Regst_App_obj extends Baseclass {
	...
	public void user_navigate_to_application_page() {
	  // Clickelement(Application);
		...
		sendkeyweb(searchappli, ConfigReader.getProperty("OrgName"));
	...
	@FindBy(xpath = "(//a[normalize-space()='Cancel'])[3]")
	...
	configWriter.setProperty("submissiondate", Table_data.get(1).getText());
		...
		List<WebElement> APP_ID1=driver.findElements(By.xpath("(//td[normalize-space()='"+ConfigReader.getProperty("Domain")+".bank.in'])[1]/preceding-sibling::td"));
		List<WebElement> Table_data1=driver.findElements(By.xpath("(//td[normalize-space()='"+ConfigReader.getProperty("Domain")+".bank.in'])[1]/following-sibling::td"));
		//validatetext(APP_ID1.get(0));
		validatetext(Table_data1.get(0), ConfigReader.getProperty("submissiondate"));
		configWriter.setProperty("submissiondate", Table_data1.get(0).getText());
		validatetext(Table_data1.get(1), "");
		validatetext(Table_data1.get(2), "Payment Not Done");
		validatetext(Table_data1.get(3), "OnHold");
		validatetext(Table_data1.get(4), "1");
		validatetext(Table_data1.get(5), "View");
		...
		private void validatetext(WebElement webElement) {
