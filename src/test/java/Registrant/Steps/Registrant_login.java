...
public class Registrant_login {
	...
	@Then("Refresh loginpage")
	public void Refresh_loginpage() throws InterruptedException {
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		RLO.Refresh_loginpage(driver);
	...
	@Then("User enter name server details Not Enter DNSSEC details {string} {string} {string}")
	public void User_enter_name_server_details_Not_Enter_DNSSEC_details(String NSR1,String IP1,String IPV6) throws Exception {
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		RLO.Validate_name_server_details_page();
		RLO.User_enter_name_server_details_Not_Enter_DNSSEC_details(NSR1,IP1,IPV6);
	}
	...
	public void User_logout_the_application1() throws Exception {
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		RLO.User_logout_the_application1();
		Thread.sleep(2000);
