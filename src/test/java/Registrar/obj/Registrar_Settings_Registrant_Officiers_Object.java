...
public class Registrar_Settings_Registrant_Officiers_Object extends Baseclass{
	...
	public void Registrar_can_check_registrant_officer_details_textvalidations_and_functionalities_in_settings_page(String srcp,String src4,String src5,String src6) throws Exception {
		...
		sendkeyweb(offser, ConfigReader.getProperty("OrgName").toUpperCase());
				...
				List<WebElement> BOOrgname=driver.findElements(By.xpath("(//td[normalize-space()='"+ConfigReader.getProperty("OrgName").toUpperCase()+"'])[2]/following-sibling::td"));
				List<WebElement> BOOrgname1=driver.findElements(By.xpath("(//td[normalize-space()='"+ConfigReader.getProperty("OrgName").toUpperCase()+"'])[2]/preceding-sibling::td"));
				//
				//
				...
				validatetext(BOOrgname.get(7), "");
				
					
				
				List<WebElement> TOOrgname=driver.findElements(By.xpath("(//td[normalize-space()='"+ConfigReader.getProperty("OrgName").toUpperCase()+"'])[3]/following-sibling::td"));
				List<WebElement> TOOrgname1=driver.findElements(By.xpath("(//td[normalize-space()='"+ConfigReader.getProperty("OrgName").toUpperCase()+"'])[3]/preceding-sibling::td"));
				//
				...
				configWriter.setProperty("Id", ADocumentType1.get(0).getText());
				...
				configWriter.setProperty("AOAdharDocStatus", ADocumentType.get(0).getText());
				configWriter.saveProperties();
				validatetext(ADocumentType.get(0), ConfigReader.getProperty("AOAdharDocStatus")); 
				configWriter.setProperty("AOAdharDocComment", ADocumentType.get(1).getText());
				configWriter.saveProperties();
				validatetext(ADocumentType.get(1), ConfigReader.getProperty("AOAdharDocComment"));
				...
				configWriter.setProperty("AOAdharDocStatus", PDocumentType.get(0).getText());
				configWriter.saveProperties();
				validatetext(PDocumentType.get(0), ConfigReader.getProperty("AOAdharDocStatus")); 
				configWriter.setProperty("AOAdharDocComment", PDocumentType.get(1).getText());
				configWriter.saveProperties();
				validatetext(PDocumentType.get(1), ConfigReader.getProperty("AOAdharDocComment"));
				...
				configWriter.setProperty("AOAdharDocStatus", OrgDocumentType1.get(0).getText());
				configWriter.saveProperties();
				validatetext(OrgDocumentType.get(0), ConfigReader.getProperty("AOAdharDocStatus")); 
				configWriter.setProperty("AOAdharDocComment", OrgDocumentType.get(1).getText());
				configWriter.saveProperties();
				validatetext(OrgDocumentType.get(1), ConfigReader.getProperty("AOAdharDocComment"));
