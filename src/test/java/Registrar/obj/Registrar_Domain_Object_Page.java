...
public class Registrar_Domain_Object_Page extends Baseclass {
	...
	public void User_Can_Check_DomaintableData_in_Domain_Page() throws Exception  {
		...
		try {
			dispalyedattribute(Orgname1.get(2), "ID");
		} catch (Exception e) {
		...
		validatetext(Orgname1.get(1), ConfigReader.getProperty("Domstatus"));
		validatetext(Orgname1.get(2), ConfigReader.getProperty("ID"));
...
//	public List<WebElement> Approvenameserver ;
	...
	@FindBy(xpath = "//button[text()='Approve Name Server']")
	public List<WebElement> Approvenameserver ;
...
//		Thread.sleep(2000);
		...
		*/
		...
		clickmultipleweb(Approvenameserver);
