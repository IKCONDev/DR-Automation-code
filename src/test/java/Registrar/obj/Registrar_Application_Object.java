...
public class Registrar_Application_Object extends Baseclass {
	...
	public void User_checkin_Application_Page3() throws Exception  {
...
@FindBy(xpath="//td[normalize-space()='1857']")
public WebElement clickidclick;
@FindBy(xpath="//p[normalize-space()='View Payment Receipt']")
public WebElement clickpayrecapprovebtn;
@FindBy(xpath="(//button[normalize-space()='Approve'])[1]")
public WebElement clickpayrecapprovebtnfinal;
@FindBy(xpath="//td[@class='mat-mdc-cell mdc-data-table__cell cdk-cell cdk-column-domainId mat-column-domainId ng-star-inserted']")
public WebElement clickidclicktemp;
@FindBy(xpath = "//button[normalize-space()='Proceed with DSC']")
public WebElement Proceedwithdsc;
public void Registrar_can_Approve_Registrant_Application_successfully() throws Exception{
...
Clickelement(clickpayrecapprovebtn);
Thread.sleep(2000);
Clickelement(clickpayrecapprovebtnfinal);
try {
...
WebElement id1=driver.findElement(By.xpath("//td[normalize-space()='"+ ConfigReader.getProperty("OrgName").toUpperCase()+"']//preceding-sibling::td"));
    ...
    //Clickelement(clickidclicktemp);
    Thread.sleep(5000);
	Clickelement(clickchkbox);
	Thread.sleep(5000);
	try {
