...
@Then("Registrar Navigate to Application Page check Re-Registration")
public void User_checkin_Application_Page3() throws Exception  {
	driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(60));
	RA.User_checkin_Application_Page3();
...
public void Registrar_Can_Check_in_Applications_Page() throws Exception  {
	...
	RA.Registrar_Can_Check_in_Applications_Page();
}
...
public void Registrar_can_Approve_Registrant_Application_successfully()throws Exception  {
	driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(60));
	RA.Registrar_can_Approve_Registrant_Application_successfully();
